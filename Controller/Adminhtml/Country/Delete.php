...
class Delete extends \Magento\Backend\App\Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'Beecom_Country::region_delete';
    /**
     *
    ...
    public function execute()
    {
        ...
        if ($region_id) {
            ...
            try {
                ...
                $model->delete();
                $this->messageManager->addSuccess(__('The '.$region_name.' Country has been deleted.'));
        ...
        // display error message
        $this->messageManager->addError(__('Country to delete was not found.'));
        // go to grid
        return $resultRedirect->setPath('*/*/');
    }
}
