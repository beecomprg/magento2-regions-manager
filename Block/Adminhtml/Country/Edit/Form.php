...
namespace Beecom\Country\Block\Adminhtml\Country\Edit;
...
class Form extends Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                'name' => 'code',
                'label' => __('State/Country/Province Code'),
                'title' => __('State/Country/Province Code'),
                'required' => true
            ]
        );
        ...
        $fieldset->addField(
            ...
            [
                'name' => 'default_name',
                'label' => __('State/Country/Province Name'),
                'title' => __('State/Country/Province Name'),
                'required' => true
            ]
        );
