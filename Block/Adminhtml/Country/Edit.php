...
namespace Beecom\Country\Block\Adminhtml\Country;
...
class Edit extends Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Beecom_Country';
        $this->_controller = 'adminhtml_region';
        parent::_construct();

        if ($this->_isAllowedAction('Beecom_Country::region_edit')) {
            ...
            if(!empty($region)) {
                if ($region->getCountryId()) {
                    $this->buttonList->add(
                        'delete',
                        [
                            'label'   => __('Delete'),
                            'class'   => 'delete',
                            'onclick' => 'deleteConfirm("Are you sure you want to delete this Country?", "'.$this->getDeleteUrl().'")'
                        ],
                        -100
                    );
                }
